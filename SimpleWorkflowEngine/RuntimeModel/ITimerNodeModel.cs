...
// Type: SimpleWorkflowEngine.RuntimeModel.ITimerNodeModel
...
{
  public interface ITimerNodeModel : IProcessNodeModel, IWorkflowMetadataSupport
  {
    string DelayDateTimeExpression { get; set; }
  }
}
